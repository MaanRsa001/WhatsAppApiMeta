...
public class PhoenixNamibiaFlowServiceImpl implements PhoenixNamibiaFlowService{
...
Logger log = LogManager.getLogger(PhoenixZambiaFlowServiceImpl.class);
	...
	@Override
	public String createNamibiaQuote(Map<String, Object> request) {
		String response="";
		String apiResponse="";
		String apiRequest="";
	...
	public Map<String, Object> namibiaFlowScreenData() {
		...
		try {
			...
			Map<String,Object> distReq = new HashMap<String,Object>();
			distReq.put("CountryId","NAM");
			distReq.put("RegionCode", "1");
			...
			String req5 = printReq.toJson(distReq);
			...
			CompletableFuture<List<Map<String,String>>> cusDist = thread.getCustomerDistrict(req5,token);
			
			CompletableFuture.allOf(cusTitle,cusRegion,cusOccupation,cusIdType,cusGender,cusDist).join();
